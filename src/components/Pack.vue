        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
          <div id="lleft" class="tab row">
            ...
            <div class="tab__content col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
              ...
              <div
                class="tab__txt"
              >Компания Frutata — новичок на рынке Узбекистана, однако несмотря на свою короткую историю мы являемся одним из немногих производителей сублимированных фруктов.</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
          <div id="rright" class="tab row">
            ...
            <div class="tab__content col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
              ...
              <div
                class="tab__txt"
              >Новичок на рынке Узбекистана, однако несмотря на свою короткую немногих производителей сублимированных фруктов.</div>
            </div>
          </div>
        </div>
      </div>
