            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
              ...
              <div class="socs d-flex">
                <a class="nav-link ps-0" href="#">
                  <i style="color: white; background: #93C92B;" class="fab fa-instagram"></i>
                </a>
                <a class="nav-link" href="#">
                  <i style="color: white; background: #93C92B;" class="fab fa-facebook-f"></i>
                </a>
                <a class="nav-link" href="#">
                  <i style="color: white; background: #93C92B;" class="fab fa-youtube"></i>
                </a>
              </div>
            </div>
